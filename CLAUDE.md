...
- **⭐ Fable 5 無料期間（〜2026-06-22）**: Claude Fable 5 が従量課金なしで利用可。**期間戦略＝「6/23 以降も残る資産」への変換に集中**（スキル・ハーネス・ドキュメント・重い執筆）。使い捨ての出力（デモ・遊び）に枠を使わない。6/12 に一斉実施: CLAUDE.md 刷新 / スキル 4 本 / ハーネス整備 / scripts 棚卸し / 体験報告書ドラフト（@docs/journal/2026-06-12.md）
- **直近の重要イベント**:
...
- **⚠️ 状態不明・要本人確認**:
  - **povo 2.0 MNP（予定 5/29-30）**: 5/8 以降の実施記録なし。**未実施なら Y!mobile が 6 月から満額 ¥4,158 発生中**（@docs/reminders.md）
