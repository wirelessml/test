...
- **⚠️ 要確認（2026/06/12 棚卸しで発覚）**: **povo 2.0 MNP（予定 5/29-30）の実施記録が 5/8 以降ない**。未実施なら Y!mobile シンプル3M の 3 ヶ月無料が 5 月で切れ、**6 月から満額 ¥4,158 が発生中**。本人に実施有無を確認 → 未実施なら早急に MNP（下記 5/29 エントリ参照）
