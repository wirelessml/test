...
- **2026/04/30（木）14:00-17:00**: **SSD 購入 @三宮**（しゅん先生 PC 用 1TB NVMe、候補 KIOXIA/Hanye/Crucial/WD、¥12,000 以下で即発注、Google Calendar 登録済、詳細 @docs/routines/ssd-price-monitor.md）
