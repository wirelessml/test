...
- [x] **4/22 大川裕介 → 大川優介 誤記を全ファイル訂正**（commit `34c8db0`）
  ...
  - ライブファイル 7 本、12 箇所を一括置換（sed）:
    - CLAUDE.md / prompt.txt / docs/google-photos-shibu-inventory.md / takeru-chatbot/knowledge/google-photos-analysis.md（6箇所）/ takeru-chatbot/knowledge/novel-three-macs.md / takeru-chatbot/knowledge/transcripts/yt-ukfCg8ZgMjA.ja.vtt / takeru-chatbot/yt-ukfCg8ZgMjA.ja.vtt
