...
- **【最優先A】京都・同志社関係**（同志社大学/女子大学/中高/**国際中高**/学校法人同志社/関連法人・生協 等。職種問わず・onsite/リモート問わず）。あれば優先掲載、無ければ該当なし。
  - **明示監視**: 『学校法人同志社 学校職員（総合職）／事務職員』採用（窓口: recruitadm.doshisha.ac.jp、www.doshisha.ac.jp/recruit、マイナビ転職等）を必ず確認。**この総合職は同志社国際中高への配属があり得る事務系**なので、再募集されたら必ず拾う（2026-06-04 時点は掲載終了＝再開待ち）。同志社国際は自校公募が体育の非常勤講師(教員免許必須)のみ＝事務は法人総合職ルートが現実的。
