# 毎朝の求人サーチ（事務職限定: 戎町500m + 関西本社リモート在宅、計~50件）

> 確定: 2026-06-04。masup WSL2 の Codex CLI で毎朝実行し、GitHub に自動公開。

## 何をするルーチンか

仲啓輔の就活用に、毎朝 **事務職**求人を最大50件集めて日次レポート化し、公開 GitHub リポジトリに push する。
...
- **① 戎町近辺（半径約500m以内）の事務職を全雇用形態で全件網羅【最優先】**（板宿駅至近の 戎町・飛松町・大黒町・大田/平田/前池町の駅寄り 等。**500m超は含めない＝件数稼ぎで範囲を広げない・事務職以外を混ぜない**が、範囲内の事務職は取りこぼさず網羅する）
- **② 50件に満たない分を在宅可（リモート/在宅）求人で補完**。優先順は **①神戸市本社または神戸市内に拠点・勤務登録地がある在宅可 ＞ ②神戸市以外の兵庫県内（明石・阪神間〔芦屋/西宮/尼崎〕等、神戸に近い順）＞ ③大阪市本社の完全在宅または出社頻度が少ない（多くて月数回まで）＞ ④京都市本社の完全在宅**。上位から先に埋め、上位が少ないときだけ下位へ広げる。本社・拠点が関西3府県のいずれにも無い「全国どこでも可の純リモート」は対象外。各件で**在宅実態（研修/機材/面談/定例出社の有無）を確認**し、所在地・在宅条件・出社頻度・未経験可否・仕事内容・応募導線をセットで明記。職種は**事務職のみ**（在宅の一般事務・営業事務・経理・データ入力・採用アシスタント・オンライン秘書等。CS/コールセンター/テクサポ/アノテーションで埋めない）。
- フィルタ: 応募者は50代。**年齢上限・生年要件で50代不可と明記された求人は除外**（ただし応募者の年齢・属性は本文に書かない＝個人情報）。
- 合計 約50件（**事務職のみ。満たなければ少ないまま提出**）。レポートは **2セクション**（戎町近辺(500m)の事務職 / 在宅可の事務職：神戸優先, 本社=兵庫/大阪/京都）。個人情報（氏名・住所・電話）は載せない。応募代行はしない（リスト化のみ）。
...
- 件名例: `【就活求人レポート】2026-06-10 計50件（事務職限定: 戎町500m＋在宅可 本社=兵庫/大阪/京都）`（2026-06-10 事務職限定に更新）、本文=レポート全文。
