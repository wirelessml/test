...
**Copilot Business アドオンを購入し、Frontier検証を開始。**

~~個人利用では「時期尚早」~~ → 実際に試して評価する方針に転換。

## 購入記録（2026年3月30日）

| 項目 | 内容 |
|------|------|
| 製品名 | Microsoft 365 Copilot Business |
| 数量 | 1ライセンス |
| 月額 | ¥3,778（税抜） |
| 税額 | ¥378 |
| 合計 | ¥4,156（税込/月） |
| 請求頻度 | 月払い |
| 初回期間 | 2026/3/30 〜 2026/4/29 |
| ライセンス割り当て | ✅ 完了 |
| 7日以内キャンセル | 可能（日割り払い戻し） |
...
- [ ] Cowork 動作確認 → **未配信**（テナントに未ロールアウト、検索結果なし）
