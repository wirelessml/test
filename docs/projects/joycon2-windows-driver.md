...
| GUI | WinUI 3 or WPF (タスクトレイ常駐) |
| 配布 | single-file exe |
| 開発環境 | Visual Studio 2022 Community or VS Code + C# Dev Kit |
...
## 物理準備 (Claude 起動前にやっておくこと)

- [ ] しゅん先生 PC に Visual Studio 2022 Community or VS Code + C# Dev Kit インストール
- [ ] .NET 8 SDK インストール
- [ ] Joy-Con 2 充電 + Switch 2 から切断 (ペアリング解除)
- [ ] Joy-Con 2 の BLE 広告モード確認
